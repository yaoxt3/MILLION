import gym
import numpy as np
from learning_to_be_taught.environments.classic_control.cart_pole_continuous_backend import ContinuousCartPoleEnv


class CartPole(gym.Env):
    def __init__(self, demonstrations_flag=True, max_episode_length=100):
        ...
        self.fake_demonstration = np.stack([np.zeros_like(self.env.observation_space.sample())])
