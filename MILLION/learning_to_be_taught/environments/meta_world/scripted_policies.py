...
policies = {
    ...
    'button-press-v1': SawyerButtonPressV2Policy,
    'button-press-topdown-wall-v1': SawyerButtonPressTopdownWallV2Policy,
    'button-press-wall-v1': SawyerButtonPressWallV2Policy,
